...
import time
tamanho = int(input("tamanho necessario"))
array = []

for v in range(tamanho):
    array.append(int(input("adicionar:")))
    print(array)
...
def bubble_sorted(array):
    ...
    print(array, "Tempo apresentado:",start_fin)
...
def shell_sort(array):
    ...
    print(array,"Tempo utilizado:",timeend)
...
if __name__=='__main__':
    while(True):
        ...
        try:
            ...
            print('Incorreto . Por favor! insira o digito ...')
